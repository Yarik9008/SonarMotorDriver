 ...
 *
 * Модуль общий для FW_SonarMotorDriver и FW_SonarMotorDriver_Sim. Конкретные
 * выводы, скорости, размеры буферов и выбор DMA/IT для USART3 приходят из
 * board.h прошивки (UART_*, UART3_* — в том числе UART3_USE_DMA, который у
 * основной прошивки и у имитатора разный).
 */
